...
urlpatterns = [
    ...
    path('feed/', feed_views.feed_page.as_view(), name='feed'),
    ...
    path('subscriptions/followed_user_id_<int:followed_user_id>/delete/', subscriptions_views.delete_subscription.as_view(), name='delete_subscription'),
